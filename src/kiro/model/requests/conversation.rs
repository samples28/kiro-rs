...
impl KiroDocument {
    /// 从 base64 数据创建文档
    pub fn from_base64(format: impl Into<String>, name: impl Into<String>, data: impl Into<String>) -> Self {
        Self {
            format: format.into(),
            name: name.into(),
            source: KiroDocumentSource::Bytes { bytes: data.into() },
        }
    }
}
